<?php if ( is_amp() && function_exists('get_post_custom_values') ) { ?>
	<?php
		...
		<div class="video-toolbar clearfix">
			...
			<div class="col-xs-6 text-right">
				<?php if ( $media ) {
					...
					<?php } else { ?>
						<a href="<?php echo make_relative_path_from_url( media_file( $media ) ); ?>" title="Please save the file by right clicking and selecting 'Save Target As' or 'Save Link As' as option." download>Download media file</a>
					<?php } ?>
				<?php } ?>
			</div>
		</div>
